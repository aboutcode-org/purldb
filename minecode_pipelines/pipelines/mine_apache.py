...
class MineApache(MineCodeBasePipeline):
    ...
    def fetch_apache(self):
        ...
        # The "find-ls2.txt.gz" is a compressed metadata manifest file
        # generated by the Apache Software Foundation. It contains a
        # recursive plaintext directory listing of every single folder and
        # file hosted on the Apache distribution archives.
