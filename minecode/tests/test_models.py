...
class ResourceURIManagerGetNextVisitableUnmappableURITestCase(TestCase):
    ...
    def test_get_next_visitable_when_one_unvisited_and_one_visited_less_than_10_days_ago(
        self,
    ):
    ...
    def test_get_next_visitable_when_one_visited_more_and_one_visited_less_than_10_days_ago(
        self,
    ):
...
class ScannableURIManagerTestCase(TestCase):
    def setUp(self):
        ...
        self.scannable_uri4 = ScannableURI.objects.create(
            uri=self.test_uri4,
            package=self.test_package4,
