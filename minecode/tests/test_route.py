...
from minecode.route import Rule
...
class RouteTest(TestCase):
    ...
    def test_that_each_processing_of_routed_class_is_done_with_a_new_instance_that_does_not_share_state(
        self,
    ):
        import time
    ...
    def test_that_multiple_patterns_can_be_used_in_a_route_decorator(self):
        ...
        @uris.route(r"http://nexb\.com", r"http://deja\.com")
        def myroute(uri):
            return "r1"
    ...
    def test_is_routable(self):
        ...
        @uris.route(r"http://nexc\.com", r"http://dejb\.com")
        def myroute2(uri):
            pass
