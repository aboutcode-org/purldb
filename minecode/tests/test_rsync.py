...
from minecode import ON_WINDOWS
    ...
    def test_entry(self):
        ...
        expected = [
            rsync.Entry(
                ...
                "rw-r--r--",
                4399746,
                "2008-11-23T16:03:57+00:00",
                "zz/ZZUL P/ZUL.gz",
            )._asdict(),
            rsync.Entry(
                "d", "rwxrwxr-x", 4096, "2004-08-09T00:47:02+00:00", "pub/sou/a/a7"
            )._asdict(),
            rsync.Entry(
                "-", "rwxrwxr-x", 4096, "2004-08-09T00:47:02+00:00", "pub/\xe5sou/a/a7"
            )._asdict(),
            None,
            None,
        ]
    ...
    def test_directory(self):
        ...
        expected = [
            rsync.Entry(
                ...
                perm="rwxrwxr-x",
                size=4096,
                date="2014-03-18T19:02:46+00:00",
                path=".",
            ),
            rsync.Entry(
                type="-",
            ...
            rsync.Entry(
                ...
                perm="rwxrwxr-x",
                size=4096,
                date="2014-02-05T09:34:20+00:00",
                path="1.4.23",
            ),
            rsync.Entry(
                type="-",
                perm="rw-rw-r--",
                size=95314,
                date="2014-02-05T09:23:44+00:00",
                path="1.4.23/CHANGELOG-1.4",
            ),
            rsync.Entry(
                type="-",
                perm="rw-rw-r--",
                size=3712820,
                date="2014-02-05T09:23:44+00:00",
                path="1.4.23/apache-wicket-1.4.23-source.tgz",
            ),
            rsync.Entry(
                type="d",
                perm="rwxrwxr-x",
            ...
            rsync.Entry(
                ...
                size=32524295,
                date="2014-02-05T09:23:44+00:00",
                path="1.4.23/binaries/apache-wicket-1.4.23.zip",
            ),
            rsync.Entry(
                type="d",
                perm="rwxrwxr-x",
                size=4096,
                date="2014-01-27T09:09:40+00:00",
                path="1.5.11",
            ),
            rsync.Entry(
                type="-",
                perm="rw-rw-r--",
                size=115587,
                date="2014-01-20T16:53:10+00:00",
                path="1.5.11/CHANGELOG-1.5",
            ),
            rsync.Entry(
                type="-",
                perm="rw-rw-r--",
                size=4116809,
                date="2014-01-20T16:53:10+00:00",
                path="1.5.11/apache-wicket-1.5.11-source.tgz",
            ),
            rsync.Entry(
                type="d",
                perm="rwxrwxr-x",
                size=4096,
                date="2014-01-27T09:09:39+00:00",
                path="1.5.11/binaries",
            ),
            rsync.Entry(
                type="-",
                perm="rw-rw-r--",
            ...
            rsync.Entry(
                ...
                size=36156260,
                date="2014-01-20T16:53:10+00:00",
                path="1.5.11/binaries/apache-wicket-1.5.11.zip",
            ),
            rsync.Entry(
                type="d",
                perm="rwxrwxr-x",
                size=4096,
                date="2014-02-19T08:36:07+00:00",
                path="6.14.0",
            ),
            rsync.Entry(
                type="-",
                perm="rw-rw-r--",
                size=78058,
                date="2014-02-14T15:51:23+00:00",
                path="6.14.0/CHANGELOG-6.x",
            ),
            rsync.Entry(
                type="-",
                perm="rw-rw-r--",
                size=4792619,
                date="2014-02-14T15:51:23+00:00",
                path="6.14.0/apache-wicket-6.14.0.tar.gz",
            ),
            rsync.Entry(
                type="-",
                perm="rw-rw-r--",
                size=9038442,
                date="2014-02-14T15:51:23+00:00",
                path="6.14.0/apache-wicket-6.14.0.zip",
            ),
            rsync.Entry(
                type="d",
                perm="rwxrwxr-x",
                size=4096,
                date="2014-02-19T08:36:05+00:00",
                path="6.14.0/binaries",
            ),
            rsync.Entry(
                type="-",
                perm="rw-rw-r--",
