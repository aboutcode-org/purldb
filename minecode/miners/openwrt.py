...
@visit_router.route(r"https://downloads.openwrt.org/.*/Packages\.gz")
    ...
    def get_uris(self, content):
        ...
        for package in debcon.get_paragraphs_data(content):
            ...
            if package_name and version:
                package_url = PackageURL(
                    type="openwrt", name=package_name, version=version
                ).to_string()
...
@visit_router.route(r"https://downloads.openwrt.org/.*\.ipk")
