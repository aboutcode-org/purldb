...
class SnippetIndexTestCase(MatchcodeTestCase):
    def setUp(self):
        ...
        for fingerprint in self.test_resource_snippets:
            fingerprint = hexstring_to_binarray(fingerprint)
            SnippetIndex.index(
                fingerprint, self.test_resource, self.test_package
            )
    ...
    def test_SnippetIndexTestCase_match(self):
        ...
        test_snippets = [hexstring_to_binarray(snippet) for snippet in test_snippets]
        results = SnippetIndex.match(test_snippets, test_resource, test_package)
