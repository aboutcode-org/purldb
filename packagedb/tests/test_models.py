...
class ResourceModelTestCase(TransactionTestCase):
    def setUp(self):
        ...
        self.resource_paths = ["root/", "root/test.json"]
...
class PackageModelTestCase(TransactionTestCase):
    ...
    def test_packagedb_package_model_update_fields(self):
        ...
        expected_history_entry = {
            ...
            "data": {
                "updated_fields": [
                    {"field": "namespace", "old_value": "", "new_value": "test"},
                    {
                        "field": "homepage_url",
                        "old_value": None,
    ...
    def test_packagedb_package_model_update_fields_special_cases(self):
        ...
        self.assertEqual(sorted(updated_fields), sorted(date_fields + ["history"]))
        ...
        self.assertEqual(string_qualifiers1, p1.qualifiers)
