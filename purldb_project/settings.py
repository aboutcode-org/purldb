...
RQ_QUEUES = {
    "default": {
        ...
        # where Redis is hosted on a separate system (e.g., cloud deployment or
        # remote Redis server) to secure data in transit.
...
FEDERATEDCODE_GIT_ACCOUNT_URL = env.str("FEDERATEDCODE_GIT_ACCOUNT_URL", default="").rstrip("/")
