#!/bin/bash
# =============================================================================
# PostgreSQL 13 to 17 Migration Script for PurlDB
# =============================================================================
#
...
docker cp "$BACKUP_FILE" purldb-db-1:/tmp/backup.dump
...
echo ""
echo "Verify with: docker compose exec db psql -U packagedb -c 'SELECT version();'"
